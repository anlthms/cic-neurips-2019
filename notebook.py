# Adapted from https://www.kaggle.com/yhn112/resnet18-baseline-pytorch-ignite
import os
import numpy as np
import pandas as pd
...
ds_eval = ImagesDS(df_eval, path_data, mode='train')
...
eval_loader = D.DataLoader(ds_eval, batch_size=batch_size, shuffle=True, num_workers=num_workers)
